import { c as createLucideIcon, r as reactExports, o, v as vt, j as jsxRuntimeExports, X, B as Button } from "./index-CHNrevQs.js";
/**
  ...
  const handleFileSelect = reactExports.useCallback(
    (file) => {
      ...
      if (accept === "image") {
        ...
        reader.onload = (e) => {
          var _a;
          setPreviewUrl((_a = e.target) == null ? void 0 : _a.result);
        };
  ...
  const triggerUpload = reactExports.useCallback(() => {
    ...
    intervalRef.current = setInterval(() => {
      ...
      if (progress >= 100) {
        ...
        const fakeCdnUrl = previewUrl ?? `https://cdn.duncantechnofab.in/media/${Date.now()}-${selectedFile.name}`;
        onUpload == null ? void 0 : onUpload(fakeCdnUrl);
      } else {
...
function MediaUpload({
  ...
  const {
    ...
    accept,
    onUpload: (url) => {
      ue.success("Upload complete!", {
        description: accept === "image" ? "Image updated successfully." : "Video uploaded successfully."
      });
      onSuccess == null ? void 0 : onSuccess(url);
    }
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body font-semibold uppercase tracking-widest text-muted-foreground mb-2", children: label }),
        activeSrc && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 rounded-md overflow-hidden border border-border relative group", children: [
          accept === "image" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: activeSrc,
              alt: "preview",
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("video", { src: activeSrc, className: "w-full h-28 object-cover", children: /* @__PURE__ */ jsxRuntimeExports.jsx("track", { kind: "captions" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-3 h-3 mr-1" }),
                selectedFile ? "Change" : "Select File"
              ]
            }
          ),
          selectedFile && !isUploading && uploadProgress < 100 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
              size: "sm",
          ...
          uploadProgress === 100 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
        ...
        (isUploading || uploadProgress > 0 && uploadProgress < 100) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
